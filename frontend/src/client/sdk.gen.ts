...
import type { ReadRootData, ReadRootResponse, ReadRootError, OpenapiData, OpenapiResponse, OpenapiError, LoginForAccessTokenData, LoginForAccessTokenResponse, LoginForAccessTokenError, GetUsersData, GetUsersResponse, GetUsersError, CreateUserData, CreateUserResponse, CreateUserError, DeleteCurrentUserData, DeleteCurrentUserResponse, DeleteCurrentUserError, GetCurrentUserData, GetCurrentUserResponse, GetCurrentUserError, UpdateCurrentUserData, UpdateCurrentUserResponse, UpdateCurrentUserError, GetUserByIdData, GetUserByIdResponse, GetUserByIdError, GetUserByUsernameData, GetUserByUsernameResponse, GetUserByUsernameError, RegisterUserData, RegisterUserResponse, RegisterUserError, DeleteUserData, DeleteUserResponse, DeleteUserError, UpdateUserData, UpdateUserResponse, UpdateUserError, GetSubmissionsData, GetSubmissionsResponse, GetSubmissionsError, CreateSubmissionData, CreateSubmissionResponse, CreateSubmissionError, GetSubmissionsByUserIdData, GetSubmissionsByUserIdResponse, GetSubmissionsByUserIdError, GetSubmissionByIdData, GetSubmissionByIdResponse, GetSubmissionByIdError, UpdateSubmissionData, UpdateSubmissionResponse, UpdateSubmissionError, GetProblemsData, GetProblemsResponse, GetProblemsError, CreateProblemData, CreateProblemResponse, CreateProblemError, GetProblemByIdData, GetProblemByIdResponse, GetProblemByIdError, GetProblemsByBlockData, GetProblemsByBlockResponse, GetProblemsByBlockError, GetProblemsBlocksData, GetProblemsBlocksResponse, GetProblemsBlocksError, ListProblemsByDifficultyData, ListProblemsByDifficultyResponse, ListProblemsByDifficultyError, DeleteProblemData, DeleteProblemResponse, DeleteProblemError, UpdateProblemData, UpdateProblemResponse, UpdateProblemError, GetRolesData, GetRolesResponse, GetRolesError, CreateRoleData, CreateRoleResponse, CreateRoleError, DeleteRoleData, DeleteRoleResponse, DeleteRoleError, GetRoleByNameData, GetRoleByNameResponse, GetRoleByNameError, UpdateRoleData, UpdateRoleResponse, UpdateRoleError, AssignRoleData, AssignRoleResponse, AssignRoleError, RevokeRoleData, RevokeRoleResponse, RevokeRoleError, GetUserRolesData, GetUserRolesResponse, GetUserRolesError, GetRoleUsersData, GetRoleUsersResponse, GetRoleUsersError, GetCommentsData, GetCommentsResponse, GetCommentsError, CreateCommentData, CreateCommentResponse, CreateCommentError, DeleteCommentData, DeleteCommentResponse, DeleteCommentError, GetCommentByIdData, GetCommentByIdResponse, GetCommentByIdError, UpdateCommentData, UpdateCommentResponse, UpdateCommentError, GetCommentsByUserIdData, GetCommentsByUserIdResponse, GetCommentsByUserIdError, GetNotificationsData, GetNotificationsResponse, GetNotificationsError, CreateNotificationData, CreateNotificationResponse, CreateNotificationError, DeleteNotificationData, DeleteNotificationResponse, DeleteNotificationError, GetNotificationByIdData, GetNotificationByIdResponse, GetNotificationByIdError, ChangeStateNotificationData, ChangeStateNotificationResponse, ChangeStateNotificationError, GetNotificationsByUserIdData, GetNotificationsByUserIdResponse, GetNotificationsByUserIdError, GetMyNotificationsData, GetMyNotificationsResponse, GetMyNotificationsError, GetReportsData, GetReportsResponse, GetReportsError, CreateReportData, CreateReportResponse, CreateReportError, GetReportsByProblemIdData, GetReportsByProblemIdResponse, GetReportsByProblemIdError, DeleteReportData, DeleteReportResponse, DeleteReportError, ChangeStateReportData, ChangeStateReportResponse, ChangeStateReportError, GetTestCasesData, GetTestCasesResponse, GetTestCasesError, CreateTestCaseData, CreateTestCaseResponse, CreateTestCaseError, DeleteTestCaseData, DeleteTestCaseResponse, DeleteTestCaseError, GetTestCaseByIdData, GetTestCaseByIdResponse, GetTestCaseByIdError, UpdateTestCaseData, UpdateTestCaseResponse, UpdateTestCaseError, GetTestCasesByProblemIdData, GetTestCasesByProblemIdResponse, GetTestCasesByProblemIdError, CodeData, CodeResponse, CodeError } from './types.gen';
...
export const openapi = <ThrowOnError extends boolean = false>(options?: Options<OpenapiData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<OpenapiResponse, OpenapiError, ThrowOnError>({
        url: '/openapi.json',
        ...options
    });
};
 ...
 */
export const getProblemsByBlock = <ThrowOnError extends boolean = false>(options: Options<GetProblemsByBlockData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetProblemsByBlockResponse, GetProblemsByBlockError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const getProblemsBlocks = <ThrowOnError extends boolean = false>(options?: Options<GetProblemsBlocksData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetProblemsBlocksResponse, GetProblemsBlocksError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const changeStateNotification = <ThrowOnError extends boolean = false>(options: Options<ChangeStateNotificationData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ChangeStateNotificationResponse, ChangeStateNotificationError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Obtener las notificaciones del usuario autentucado
 */
 ...
 */
export const changeStateReport = <ThrowOnError extends boolean = false>(options: Options<ChangeStateReportData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ChangeStateReportResponse, ChangeStateReportError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const code = <ThrowOnError extends boolean = false>(options: Options<CodeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CodeResponse, CodeError, ThrowOnError>({
        url: '/code/',
        ...options
    });
};