...
import type { ReadRootData, OpenapiData, LoginForAccessTokenData, LoginForAccessTokenResponse, LoginForAccessTokenError, GetUsersData, GetUsersResponse, CreateUserData, CreateUserResponse, CreateUserError, DeleteCurrentUserData, DeleteCurrentUserResponse, GetCurrentUserData, GetCurrentUserResponse, UpdateCurrentUserData, UpdateCurrentUserResponse, UpdateCurrentUserError, GetUserByIdData, GetUserByIdResponse, GetUserByIdError, GetUserByUsernameData, GetUserByUsernameResponse, GetUserByUsernameError, RegisterUserData, RegisterUserResponse, RegisterUserError, DeleteUserData, DeleteUserResponse, DeleteUserError, UpdateUserData, UpdateUserResponse, UpdateUserError, GetSubmissionsData, GetSubmissionsResponse, CreateSubmissionData, CreateSubmissionResponse, CreateSubmissionError, GetSubmissionsByUserIdData, GetSubmissionsByUserIdResponse, GetSubmissionsByUserIdError, GetSubmissionByIdData, GetSubmissionByIdResponse, GetSubmissionByIdError, UpdateSubmissionData, UpdateSubmissionResponse, UpdateSubmissionError, GetProblemsData, GetProblemsResponse, GetProblemsError, CreateProblemData, CreateProblemResponse, CreateProblemError, GetProblemByIdData, GetProblemByIdResponse, GetProblemByIdError, GetProblemsByBlockData, GetProblemsByBlockResponse, GetProblemsByBlockError, GetProblemsBlocksData, GetProblemsBlocksResponse, ListProblemsByDifficultyData, ListProblemsByDifficultyResponse, ListProblemsByDifficultyError, DeleteProblemData, DeleteProblemResponse, DeleteProblemError, UpdateProblemData, UpdateProblemResponse, UpdateProblemError, GetRolesData, GetRolesResponse, CreateRoleData, CreateRoleResponse, CreateRoleError, DeleteRoleData, DeleteRoleResponse, DeleteRoleError, GetRoleByNameData, GetRoleByNameResponse, GetRoleByNameError, UpdateRoleData, UpdateRoleResponse, UpdateRoleError, AssignRoleData, AssignRoleResponse, AssignRoleError, RevokeRoleData, RevokeRoleResponse, RevokeRoleError, GetUserRolesData, GetUserRolesResponse, GetUserRolesError, GetRoleUsersData, GetRoleUsersResponse, GetRoleUsersError, GetCommentsData, GetCommentsResponse, CreateCommentData, CreateCommentResponse, CreateCommentError, DeleteCommentData, DeleteCommentResponse, DeleteCommentError, GetCommentByIdData, GetCommentByIdResponse, GetCommentByIdError, UpdateCommentData, UpdateCommentResponse, UpdateCommentError, GetCommentsByUserIdData, GetCommentsByUserIdResponse, GetCommentsByUserIdError, GetNotificationsData, GetNotificationsResponse, CreateNotificationData, CreateNotificationResponse, CreateNotificationError, DeleteNotificationData, DeleteNotificationResponse, DeleteNotificationError, GetNotificationByIdData, GetNotificationByIdResponse, GetNotificationByIdError, ChangeStateNotificationData, ChangeStateNotificationResponse, ChangeStateNotificationError, GetNotificationsByUserIdData, GetNotificationsByUserIdResponse, GetNotificationsByUserIdError, GetMyNotificationsData, GetMyNotificationsResponse, GetReportsData, GetReportsResponse, CreateReportData, CreateReportResponse, CreateReportError, GetReportsByProblemIdData, GetReportsByProblemIdResponse, GetReportsByProblemIdError, DeleteReportData, DeleteReportResponse, DeleteReportError, ChangeStateReportData, ChangeStateReportResponse, ChangeStateReportError, GetTestCasesData, GetTestCasesResponse, CreateTestCaseData, CreateTestCaseResponse, CreateTestCaseError, DeleteTestCaseData, DeleteTestCaseResponse, DeleteTestCaseError, GetTestCaseByIdData, GetTestCaseByIdResponse, GetTestCaseByIdError, UpdateTestCaseData, UpdateTestCaseResponse, UpdateTestCaseError, GetTestCasesByProblemIdData, GetTestCasesByProblemIdResponse, GetTestCasesByProblemIdError } from './types.gen';
...
export const getProblemsBlocks = <ThrowOnError extends boolean = false>(options?: Options<GetProblemsBlocksData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetProblemsBlocksResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getRoles = <ThrowOnError extends boolean = false>(options?: Options<GetRolesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetRolesResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getComments = <ThrowOnError extends boolean = false>(options?: Options<GetCommentsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetCommentsResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
