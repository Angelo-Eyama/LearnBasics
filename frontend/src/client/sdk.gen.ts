 ...
 */
export const testFunction = <ThrowOnError extends boolean = false>(options: Options<TestFunctionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TestFunctionResponse, TestFunctionError, ThrowOnError>({
