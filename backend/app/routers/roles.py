...
@router.get("/roles/", response_model=List[RoleRead], tags=["Roles"], summary="Obtener todos los roles", description="Obtiene todos los roles del sistema.")
def get_roles(session: Session = Depends(get_session)):
    roles = roles_controller.get_roles(session)
    return roles

@router.get("/roles/{role_id}", response_model=RoleRead, tags=["Roles"], summary="Obtener un rol por su ID", description="Obtiene un rol del sistema utilizando su ID.")
...
@router.post("/roles/", response_model=RoleCreate, tags=["Roles"], summary="Crear un rol", description="Crea un nuevo rol en el sistema.")
...
@router.patch("/roles/{role_id}", response_model=RoleUpdate, tags=["Roles"], summary="Actualizar un rol", description="Actualiza un rol del sistema utilizando su ID.")
...
@router.delete("/roles/{role_id}", response_model=RoleRead, tags=["Roles"], summary="Eliminar un rol", description="Elimina un rol del sistema utilizando su ID.", response_description="El rol eliminado.")
...
@router.post("/roles/{role_id}/assign/{user_id}", response_model=UserWithRoles, tags=["Roles"], summary="Asignar un rol a un usuario", description="Asigna un rol a un usuario.")
...
@router.post("/roles/{role_id}/revoke/{user_id}", response_model=UserWithRoles, tags=["Roles"], summary="Revocar un rol a un usuario", description="Revoca un rol a un usuario.")
...
@router.get("/roles/user/{user_id}", response_model=List[RoleWithUsers], tags=["Roles"], summary="Obtener todos los roles de un usuario", description="Obtiene todos los roles de un usuario.")
...
@router.get("/roles/{role_id}/users", response_model=List[UserWithRoles], tags=["Roles"], summary="Obtener todos los usuarios de un rol", description="Obtiene todos los usuarios de un rol.")
