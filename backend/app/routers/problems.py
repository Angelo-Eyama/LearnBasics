...
@router.get("/problems/id:{problem_id}", response_model=ProblemRead)
...
@router.get("/problems/{block}", response_model=List[ProblemRead])
...
@router.patch("/problems/{problem_id}", response_model=ProblemUpdate)
...
@router.delete("/problems/{problem_id}", response_model=ProblemRead, summary="Eliminar un problema", description="Elimina un problema del sistema utilizando su ID.", response_description="El problema eliminado.")
